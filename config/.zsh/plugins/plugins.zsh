...
[[ -f $ZSH_PLUGDIR/z/z.sh ]] && source $ZSH_PLUGDIR/z/z.sh

# ==== zsh-autosuggestions config ====
if is-at-least 5.1.1 && [[ -f  $ZSH_PLUGDIR/zsh-autosuggestions/zsh-autosuggestions.zsh ]]; then
...
if [[ -z "${FAST_BASE_DIR}" ]] && [[ -f ${ZSH_PLUGDIR}/fast-syntax-highlighting/fast-syntax-highlighting.plugin.zsh ]]; then
