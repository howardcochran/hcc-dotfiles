...
let g:airline#themes#cool_hcc#palette = {}

" NORMAL
"" let s:N1   = [ '#585858' , '#E4E4E4' , 16  , 188 ]
"" let s:N2   = [ '#E4E4E4' , '#0087AF' , 188 , 31 ]
"" let s:N3   = [ '#EEEEEE' , '#005F87' , 231  , 24]
"" let g:airline#themes#cool_hcc#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
"" let g:airline#themes#cool_hcc#palette.normal_modified = {
""     \ 'airline_c': [ '#ffffff' , '#5f005f' , 231     , 52      , 'bold'     ] ,
""     \ }

let s:N1   = [ '#585858' , '#E4E4E4' , 16  , 188 ]
let s:N2   = [ '#E4E4E4' , '#0087AF' , 188 , 31 ]
let s:N3   = [ '#EEEEEE' , '#005F87' , 16  , 87 ]
let g:airline#themes#cool_hcc#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#cool_hcc#palette.normal_modified = {
    \ 'airline_c': [ '#ffffff' , '#5f005f' , 16     , 161      , 'bold'     ] ,
    \ }

" INSERT
let s:I1 = [ '#585858' , '#E4E4E4' , 16  , 160  ]
let s:I2 = [ '#E4E4E4' , '#47AF00' , 188 , 70  ]
"let s:I3 = [ '#EEEEEE' , '#2E8700' , 231  , 52 ]
let s:I3 = copy(s:N3)
let g:airline#themes#cool_hcc#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#cool_hcc#palette.insert.airline_y = copy(g:airline#themes#cool_hcc#palette.normal.airline_y)
let g:airline#themes#cool_hcc#palette.insert.airline_z = copy(g:airline#themes#cool_hcc#palette.normal.airline_z)
let g:airline#themes#cool_hcc#palette.insert_modified = copy(g:airline#themes#cool_hcc#palette.normal_modified)
"let g:airline#themes#cool_hcc#palette.insert_paste = {
"      "\ 'airline_c': [ s:I3[0]   , s:I3[1] , s:I3[2] , 15     , ''     ] ,
"      "\ }
...
let g:airline#themes#cool_hcc#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
"let g:airline#themes#cool_hcc#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
"let g:airline#themes#cool_hcc#palette.replace_modified = g:airline#themes#cool_hcc#palette.insert_modified

" VISUAL
let g:airline#themes#cool_hcc#palette.visual = deepcopy(g:airline#themes#cool_hcc#palette.normal)
let g:airline#themes#cool_hcc#palette.visual.airline_a[3] = 121
let g:airline#themes#cool_hcc#palette.visual_modified = deepcopy(g:airline#themes#cool_hcc#palette.normal_modified)
"let g:airline#themes#cool_hcc#palette.visual_modified = {
      "\ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      "\ }

" COMMANDLINE
let g:airline#themes#cool_hcc#palette.commandline = deepcopy(g:airline#themes#cool_hcc#palette.normal)
let g:airline#themes#cool_hcc#palette.commandline.airline_a[3] = 85
let g:airline#themes#cool_hcc#palette.commandline_modified = deepcopy(g:airline#themes#cool_hcc#palette.normal_modified)

" INACTIVE
"" let s:IA1 = [ '#585858' , '#E4E4E4' , 59 , 188 , '' ]
"" let s:IA2 = [ '#E4E4E4' , '#466D79' , 188 , 60 , '' ]
"" let s:IA3 = [ '#EEEEEE' , '#324E59' , 231 , 238 , '' ]
"" let g:airline#themes#cool_hcc#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
"" let g:airline#themes#cool_hcc#palette.inactive_modified = {
""       \ 'airline_c': [ '#875faf' , '' , 255 , 53 , '' ] ,
""       \ }

let s:IA1 = [ '#585858' , '#E4E4E4' , 59 , 188 , '' ]
let s:IA2 = [ '#E4E4E4' , '#466D79' , 188 , 60 , '' ]
let s:IA3 = [ '#EEEEEE' , '#324E59' , 16 , 247 , '' ]
let g:airline#themes#cool_hcc#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
let g:airline#themes#cool_hcc#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 16 , 131 , '' ] ,
      \ }


let g:airline#themes#cool_hcc#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 196 , ''  ]
      \ }
